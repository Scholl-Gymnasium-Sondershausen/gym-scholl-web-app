                                    ...
                                    <nav className="mmn navbar navbar-expand-md navbar-dark sticky-top">
                                        ...
                                        <div className="collapse navbar-collapse" id="mmn1">
                                            <ul className="header-menu navbar-nav text-capitalize">
                                                ...
                                                <li><a onClick={this.setRedirect} href="#Themenbereiche" className="nav-link">Themenbereiche</a></li>
                                                <li><a onClick={this.setRedirect} href="#team" className="nav-link">Belegschaft</a></li>
                                                <li><a onClick={this.setRedirect} href="#portfolio" className="nav-link">Schul-AG's</a></li>
                                                <li>
